...
const AppBar = ({ signinBtnDisplay, signinBtnVisable }) => {
  ...
  return (
    <div className=" w-full bg-main-1 fixed top-0 left-0 z-50 md:relative">
      <div className="container mx-auto flex flex-wrap items-center justify-between py-2">
        ...
        <div
          className={`flex ${
            location.pathname.startsWith("/signIn")
              ? "justify-center"
              : "justify-between"
          }  w-full md:w-1/3 md:text-left mt-3`}
        >
          ...
          <div
            className={`pl-3 flex items-center  md:hidden ${signinBtnDisplay}`}
          >
            <BtnAnimation
              title="ثبت نام کارجو"
              color="#fff"
        ...
        <div className="hidden md:flex md:w-1/2 justify-around text-lg mt-3">
          ...
          <div className="flex flex-col items-start font-bold">
            ...
            <p className="">آدرس</p>
            <p className="">تهران، خیابان اصل</p>
          </div>
          ...
          <div className="flex flex-col items-start font-bold">
            ...
            <p className="">{toPersianDigits(`0123456789`)}</p>
          </div>
      ...
      <NavBar signinBtnVisable={signinBtnVisable} />
    </div>
  );
};
